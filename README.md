...
This repository contains a simple shell script (`startup.sh`) that I use to kick off my coding practice sessions. It's a fun way for me to see a collection of the different algorithms and data structures I'm currently learning about.This Project
